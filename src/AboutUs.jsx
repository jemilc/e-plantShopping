...
// Asegúrate de que el componente AboutUs reciba la prop onContinueShopping
function AboutUs({ onContinueShopping }) {
  return (
    <div className="about-us-container" style={{ textAlign: 'center', padding: '50px', color: 'black' }}>
      {/* <h1 className="about-us-heading">About Us</h1> */}
      <h2>About Paradise Nursery</h2> {/* Agregué un H2 para el título */}
      ...
      {/* Puedes necesitar estilos para .get-started-button en AboutUs.css o ProductList.css */}
    </div>
  );
}
